...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('day_follow_quarter_limit_count')->nullable()->comment('15フォロー/15分の回数をカウントする');
            $table->timestamp('day_follow_quarter_release_time')->nullable()->comment('15フォロー/15分の制限を解除する基準の時刻が入る');
            $table->timestamp('day_follow_release_time')->nullable()->comment('1日のフォロー上限の制限を解除する基準の時刻が入る');
