<template>
  <div>
    <main class="l-main">
        ...
        <div class="c-container__index">
          <div class="p-sitemap">
            <div class="p-sitemap__pic">
              <img src="storage/img/section01.png" alt />
            </div>
      ...
      <section class="c-container__bg">
        <div class="c-container__index">
          <div class="p-sitemap p-sitemap--reverse">
            <div class="p-sitemap__pic">
              <img src="storage/img/section02.jpg" alt />
            </div>
            <div class="p-sitemap__info">
      ...
      <section class="c-container__bg">
        <div class="c-container__index">
          <div class="p-sitemap">
            <div class="p-sitemap__pic">
              <img src="storage/img/section03.jpg" alt />
            </div>
            <div class="p-sitemap__info">
    ...
    <footer class="l-footer">
      <div class="p-footer">
        <p class="p-footer__text">Copyright © CRYPTO TOREND All Rights Reserved</p>
      </div>
      <ul class="p-footer__list">
        <li class="p-footer__item">
          <a class="p-footer__item--link" href="rule.html">利用規約</a>
        </li>
        <li class="p-footer__item">
          <a class="p-footer__item--link" href="policy.html">プライバシーポリシー</a>
        </li>
        <li class="p-footer__item">
          <a class="p-footer__item--link" href="contact.html">お問い合わせ</a>
        </li>
      </ul>
    </footer>
  </div>
