      ...
      <div class="c-container__auth c-container__auth__contact">
        ...
        <div class="p-form__body">
          ...
          @csrf
            ...
            <textarea id="conatct-message" name="contact" cols="30" rows="8"
            class="c-form__input p-form__contact @error('email') c-error__input @enderror" >{{old('contact')}}</textarea>
            <div class="p-form__contact__text--clear">
              <p class="p-form__contact__text">0/1000文字以内</p>
